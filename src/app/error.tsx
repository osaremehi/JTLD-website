    ...
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-6">
          We encountered an unexpected error. Please try again or contact us at{" "}
          <a href="mailto:info@jtldinc.com" className="text-primary-600 dark:text-primary-400 underline">
            info@jtldinc.com
          </a>
        </p>
        <button
